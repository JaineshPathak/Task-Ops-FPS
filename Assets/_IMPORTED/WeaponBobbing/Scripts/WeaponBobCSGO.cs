...
namespace WeaponBobbing
{
	public class WeaponBobCSGO : WeaponBobBase 
	{
		...
		public float maxFrontBobMovement = 0.05f;
		public float frontBobbingSpeed = 1.0f;
		public float sideBobbingSpeed = 0.15f;
		public float sideBobbingAmount = 0.02f;
		...
		void FixedUpdate()
        {
			...
			frontBobMovementAmount *= Time.fixedDeltaTime;
			...
			transform.localPosition = Vector3.Lerp(transform.localPosition, calcPosition, Time.fixedDeltaTime * INTERNAL_MULTIPLIER * bobMultiplier);
		}
	}
}